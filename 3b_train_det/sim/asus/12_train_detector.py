...
model.train(
    data='1_data_config.yaml',      # Ruta al archivo .yaml con la configuración del dataset
    ...
    project='../../../output/models/detection/sim/',        # Carpeta donde se guardarán los resultados
    name='asus_exp1' # Nombre del experimento
)
...
results = model.val(
    data='data_config.yaml',      # Usa la misma configuración del dataset
    imgsz=(img_width, img_height), # Dimensiones personalizadas de las imágenes
