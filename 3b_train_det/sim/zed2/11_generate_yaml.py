...
data_config = {
    'path': '/app/paths/1_without_back_without_blur',  # Ruta base
...
with open('data/1_data_config.yaml', 'w') as file:
    yaml.dump(data_config, file, default_flow_style=False)

print("Archivo '1_data_config.yaml' generado correctamente.")
