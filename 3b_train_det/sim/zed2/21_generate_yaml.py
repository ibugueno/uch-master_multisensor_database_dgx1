...
with open(f'data/{exp_path[:1]}_data_config.yaml', 'w') as file:
    yaml.dump(data_config, file, default_flow_style=False)

print(f"Archivo '{exp_path[:1]}_data_config.yaml' generado correctamente.")
