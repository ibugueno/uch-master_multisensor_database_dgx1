...
# Ejemplo de uso
root_path = 'output/ddbb-s-events/2_without_back_noisy/'  # Especifica el directorio raíz
txt_file = 'data/output_not_in_root.txt'  # Especifica el archivo .txt con las rutas relativas
