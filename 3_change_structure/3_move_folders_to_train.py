...
def process_and_move_images(txt_file, output_folder, path_to_remove=""):
    """
    ...
    for image_path in image_paths:
        ...
        # Mover la imagen al nuevo destino con el nuevo nombre
...
sensor = 'asus'
txt_file = f'data/output_ddbs-s_labels_original_segmentation_{sensor}_files.txt'  # Ruta al archivo .txt con rutas de imágenes
output_folder = "output/ddbb-s_labels/segmentation"          # Carpeta de destino para las imágenes renombradas
path_to_remove = "output/ddbs-s_labels_original/segmentation"         # Parte de la ruta que se debe eliminar

# Ejecutar la función
process_and_move_images(txt_file, output_folder, path_to_remove)
