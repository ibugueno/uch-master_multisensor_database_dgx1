...
# Especificar rutas
input_txt = "data/labels_detection_yolo_files.txt"  # Archivo de entrada con rutas a .txt
output_txt = "data/list_images_files.txt"  # Archivo de salida con rutas modificadas
