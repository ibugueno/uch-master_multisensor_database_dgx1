...
input_txt = "data/images_extra_files.txt"  # Archivo .txt con las rutas relativas
source_prefix = "output/2_without_back_with_blur"            # Prefijo para las rutas originales
output_root = f"{source_prefix}/ddbb_struct"    # Directorio de destino
