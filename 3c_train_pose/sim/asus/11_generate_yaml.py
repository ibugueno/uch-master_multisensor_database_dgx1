...
if __name__ == "__main__":
    ...
    train_label_dir = f"input/labels-events/pose/train/{sensor}"
    val_image_dir = f"input/ddbb-s-events/{exp_path}/val/{sensor}"
    val_label_dir = f"input/labels-events/pose/val/{sensor}"
    test_image_dir = f"input/ddbb-s-events/{exp_path}/test/{sensor}"
    test_label_dir = f"input/labels-events/pose/test/{sensor}"
    ...
    output_dir = f"output/{sensor}_{exp_path[:1]}"
