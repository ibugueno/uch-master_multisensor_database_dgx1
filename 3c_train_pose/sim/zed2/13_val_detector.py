...
def main():
    ...
    # Pesos preentrenados
    yolo_weights_path = f'../output/ddbb-s-frames/detection/{sensor}_exp{exp}_/weights/best.pt'
    pose_weights_path = f'../output/ddbb-s-frames/pose6d-fixed/{sensor}_{exp}/pose_model_epoch_{exp}.pth'
