...
if __name__ == "__main__":
    exp_path = '4_with_back_noisy'
    sensor = 'davis346'
    train_image_dir = f"input/ddbb-s-events/{exp_path}/train/{sensor}"
    train_mask_dir = f"input/labels-events-2/segmentation/train/{sensor}"
    val_image_dir = f"input/ddbb-s-events/{exp_path}/val/{sensor}"
    val_mask_dir = f"input/labels-events-2/segmentation/val/{sensor}"
